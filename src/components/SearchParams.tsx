				...
				<div className='grid grid-rows-2 grid-flow-col'>
					<div className='row-span-3'>
						...
						>
							...
							<button className='flex justify-center mx-auto rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'>
								Submit
							</button>
						</form>
					</div>
